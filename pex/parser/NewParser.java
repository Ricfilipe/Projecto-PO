...
public class NewParser {
    ...
    public Expression parseString(String expression, Program program, Interpreter interpreter) throws BadSourceException, BadNumberException, InvalidExpressionException,
                                                                             MissingClosingParenthesisException, UnknownOperationException, EndOfInputException {
        _program = program;
        _interpreter = interpreter;
    ...
    private CompositeExpression parseCompositeExpression() throws IOException, BadNumberException, UnknownOperationException, MissingClosingParenthesisException,
        ...
        switch (operatorName) {
            ...
            case "reads":
                return new ReadS(_interpreter);

            case "readi":
                return new ReadI(_interpreter);
            ...
            case "ge":
             ...
             case "print":
                 ...
                 if (operatorName.equals("seq"))
                     ...
                     return new Print(args, _interpreter);
